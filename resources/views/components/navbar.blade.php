        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <img src="/image/logo.jpg"
                            alt="Logo Atlet Indonesia - Lambang dengan
                            ilustrasi atlet yang sedang berlari dengan latar merah putih"
                            class="h-8 w-8">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        <a href="#"
                            class="border-red-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Beranda</a>
                        <a href="#cabang-olahraga"
                            class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Cabang
                            Olahraga</a>
                        <a href="#daftar-atlet"
                            class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Daftar
                            Atlet</a>
                        <a href="#prestasi"
                            class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Prestasi</a>
                    </div>
                </div>
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    ...
                    <button
                        class="ml-3 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all">Masuk</button>
                </div>
    ...
    <script>
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <div class="px-5">
                    <input type="text" placeholder="Cari atlet..." class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                </div>
